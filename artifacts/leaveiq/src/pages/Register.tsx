    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: `linear-gradient(135deg, ${C.bg} 0%, #EBE3D4 100%)` }}>
      <div className="w-full max-w-md">
        <div className="flex flex-col items-center mb-8">
          <img src="/guildlight-mark-flat.svg" alt="Guildlight" className="h-16 w-16 object-contain mb-4" />
        ...
        <div className="rounded-2xl p-8 shadow-lg border" style={{ background: C.card, borderColor: C.border }}>
          {validating ? (
            ...
            <div className="text-center">
              ...
              <Link href="/leave/login" className="text-sm font-medium transition-colors hover:opacity-80" style={{ color: C.terracotta }}>
                Back to sign in
              </Link>
            </div>
          ) : !token ? (
            <div className="text-center">
              <img src="/guildlight-mark-flat.svg" alt="Guildlight" className="h-14 w-14 object-contain mx-auto mb-4" />
