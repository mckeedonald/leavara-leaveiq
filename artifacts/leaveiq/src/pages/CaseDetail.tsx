          ...
          <div>
            ...
            <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-muted-foreground">
              ...
              {(caseData as { assignedToUserId?: string | null }).assignedToUserId ? (
                <span className="flex items-center gap-1.5 bg-[#F5EFE2] text-[#8E6A45] px-2 py-0.5 rounded text-xs font-semibold">
              ...
              {!(caseData as { assignedToUserId?: string | null }).assignedToUserId && (
                <button
                  ...
                  style={{ borderColor: "#B68B5E", color: "#8E6A45", background: "#FBF7EF" }}
              ...
              <div className="bg-card border shadow-sm rounded-2xl overflow-hidden">
                <div className="bg-slate-50 border-b p-6 flex items-center justify-between">
                  <h3 className="font-display font-bold text-lg flex items-center gap-2">
                    <Activity className="w-5 h-5 text-[#B68B5E]" />
                    Eligibility Analysis
                  </h3>
                    ...
                    {(analysis.eligiblePrograms as any[]).filter((p: any) => {
                      ...
                      <div
                        ...
                        className={cn(
                          ...
                          p.eligible ? "border-[#C97E5966] bg-[#FBF7EF]/50" : "border-slate-200 bg-slate-50/50",
                        )}
                      >
                        <div className="flex items-center gap-3">
                          {p.eligible ? <CheckCircle className="w-5 h-5 text-[#B68B5E]" /> : <XCircle className="w-5 h-5 text-slate-400" />}
                          <div>
                        ...
                        {p.eligible && p.entitlementWeeks && (
                          <span className="text-xs font-bold uppercase px-2 py-1 rounded-md" style={{ color: "#8E6A45", background: "#F5EFE2" }}>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-card border shadow-sm rounded-2xl p-6">
              <h3 className="font-display font-bold text-lg border-b pb-3 mb-4 flex items-center gap-2">
                <ShieldAlert className="w-5 h-5 text-[#B68B5E]" />
                HR Decisions
              </h3>
              {decisions.length === 0 ? (
                ...
                <div className="space-y-4">
                  ...
                  {decisions.map((d: any) => (
                    <div key={d.id} className="relative pl-6 pb-4 border-l-2 border-slate-200 last:border-0 last:pb-0">
                      <div className="absolute w-3 h-3 rounded-full -left-[7px] top-1 ring-4 ring-white" style={{ background: "#B68B5E" }} />
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: "rgba(0,0,0,0.45)" }}>
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 animate-in">
        ...
        <div className="mb-4">
          <label className="block text-sm font-semibold mb-1.5" style={{ color: "#18263A" }}>
