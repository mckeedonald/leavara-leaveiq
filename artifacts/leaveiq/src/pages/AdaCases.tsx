      ...
      <div className="bg-card w-full max-w-lg rounded-2xl shadow-2xl border flex flex-col overflow-hidden animate-in slide-in-from-bottom-4 duration-300">
        ...
        <div className="p-6 border-b flex justify-between items-center bg-slate-50/50">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg flex items-center justify-center" style={{ background: "#F1E7CF" }}>
              <ShieldCheck className="w-4 h-4" style={{ color: "#B68B5E" }} />
            </div>
  ...
  return (
    <AppLayout>
      <div className="mb-8 animate-in opacity-0 stagger-1">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: "#F1E7CF" }}>
            <ShieldCheck className="w-5 h-5" style={{ color: "#B68B5E" }} />
          </div>
          <div>
      ...
      <div className="bg-card border shadow-sm rounded-2xl overflow-hidden animate-in opacity-0 stagger-2">
        ...
        {isLoading ? (
          <div className="p-20 flex flex-col items-center justify-center text-muted-foreground">
            <Loader2 className="w-8 h-8 animate-spin mb-4" style={{ color: "#B68B5E" }} />
                ...
                {cases.length === 0 ? (
                  <tr>
                    <td colSpan={6} className="px-6 py-16 text-center text-muted-foreground">
                      <ShieldCheck className="w-10 h-10 mx-auto mb-3 opacity-30" style={{ color: "#B68B5E" }} />
                      ...
                      <tr key={c.id} className="hover:bg-muted/20 transition-colors group">
                        <td className="px-6 py-4">
                          <Link href={`/leave/ada-cases/${c.id}`}>
                            <span className="font-mono font-semibold text-xs hover:underline cursor-pointer" style={{ color: "#B68B5E" }}>
                              {c.caseNumber}
                            </span>
                          </Link>
                        </td>
