    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-6" style={{ background: C.bg, fontFamily: "Inter, sans-serif" }}>
        <div className="w-full max-w-md text-center">
          ...
          <img src="/guildlight-mark-flat.svg" alt="Guildlight" className="h-10 w-10 object-contain mx-auto mb-3" />
    ...
    <div className="min-h-screen flex flex-col" style={{ background: C.bg, fontFamily: "Inter, sans-serif" }}>
      ...
      <main className="flex-1 flex items-start justify-center px-6 py-14">
        <div className="w-full max-w-xl">
          <div className="mb-8">
            <img src="/guildlight-mark-flat.svg" alt="Guildlight" className="h-12 w-12 object-contain mb-4" />
